-- ==========================================
-- 🗄️ قاعدة البيانات الكاملة للمنصة التعليمية
...
CREATE TABLE IF NOT EXISTS public.discussions (
  ...
  lesson_id UUID,
  user_id TEXT NOT NULL,
  parent_id UUID REFERENCES public.discussions(id), -- للردود
  content TEXT NOT NULL,
...
-- سياسات مبسطة للبداية (يمكن تعديلها لاحقاً)
...
CREATE POLICY "Allow all operations" ON public.conversations FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON public.enrollments FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON public.lessons FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON public.student_progress FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON public.exams FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON public.exam_results FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON public.certificates FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON public.discussions FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON public.reviews FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON public.announcements FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations" ON public.live_sessions FOR ALL USING (true) WITH CHECK (true);
